...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        `
          fixed inset-0 z-50 bg-media-scrim/60 backdrop-blur-sm
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          `
            ...
            -translate-x-1/2 -translate-y-1/2 gap-4 rounded-lg border border-line
            bg-background p-6 text-foreground shadow-amanah-card duration-200
            outline-none
            data-[state=closed]:animate-out data-[state=closed]:fade-out-0
