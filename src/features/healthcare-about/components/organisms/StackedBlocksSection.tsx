...
const PRINCIPLES: PrincipleBrick[] = [
  {
    ...
    icon: <PixelHeartIcon />,
    id: 'ramah',
    imageSrc: '/assets/images/about-blocks/about-us-ramah.webp',
    revealDirection: 1,
  ...
  },
  {
    ...
    id: 'profesional',
    imageSrc: '/assets/images/about-blocks/about-us-professionl.webp',
    revealDirection: -1,
  ...
  },
  {
    ...
    icon: <PixelBoltIcon />,
    id: 'cepat',
    imageSrc: '/assets/images/about-blocks/about-us-cepat.webp',
    revealDirection: 1,
  ...
  },
  {
    ...
    id: 'aman',
    imageSrc: '/assets/images/about-blocks/about-us-aman.webp',
    revealDirection: -1,
    ringClass: 'ring-amanah-mint/40',
    row: 2,
    title: 'Aman',
  },
  {
    ...
    icon: <PixelCheckIcon />,
    id: 'terpercaya',
    imageSrc: '/assets/images/about-blocks/about-us-terpercaya.webp',
    revealDirection: 1,
    ringClass: 'ring-amanah-blue/40',
    row: 2,
    title: 'Terpercaya',
  },
  {
    ...
    icon: <PixelCareIcon />,
    id: 'peduli',
    imageSrc: '/assets/images/about-blocks/about-us-perduli.webp',
    revealDirection: 1,
    ringClass: 'ring-amanah-sky/40',
    row: 3,
    title: 'Peduli',
